...
' ============================================================================
' BACKUP/RESTORE BASE DE DATOS
' ============================================================================

Public Function BackupDatabase(ByVal sourceDBPath As String, ByVal backupPath As String) As Boolean
    On Error GoTo ErrHandler
    ...
    If Not fso.FileExists(sourceDBPath) Then
        Debug.Print "[ERR] BackupDatabase: Base de datos origen no existe: " & sourceDBPath
...
ErrHandler:
    Debug.Print "[ERR] BackupDatabase: " & Err.Description
    BackupDatabase = False
End Function

Public Function RestoreDatabase(ByVal backupPath As String, ByVal destDBPath As String) As Boolean
    On Error GoTo ErrHandler
    ...
    If Not fso.FileExists(backupPath) Then
        Debug.Print "[ERR] RestoreDatabase: Backup no existe: " & backupPath
    ...
    If fso.FileExists(destDBPath) Then
        Debug.Print "[WARN] RestoreDatabase: Sobrescribiendo base de datos existente: " & destDBPath
    End If
...
ErrHandler:
    Debug.Print "[ERR] RestoreDatabase: " & Err.Description
    RestoreDatabase = False
End Function
